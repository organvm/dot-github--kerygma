# Contributing to ORGAN-VII: Marketing (Kerygma)
...
This organization covers: Content distribution, announcement templates, social automation.
...
- New distribution channels, automation workflow changes, template format changes

## Licensing

Content follows the POSSE methodology (Publish Own Site, Syndicate Elsewhere). All original content lives in ORGAN-V; ORGAN-VII handles distribution.
